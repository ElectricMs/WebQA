...
<script>
  ...
  const followCursor = (el, xRatio, yRatio) => {
    ...
    const distanceLeft = Math.round((cursorPos.x - centerX) * 70 / window.innerWidth);
    const distanceTop = Math.round((cursorPos.y - centerY) * 70 / window.innerHeight);
